...
#
# Script generated by Vivado on Tue May 23 23:39:38 +0800 2023
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/XO-PersonalWorkspace/Personal_Project/VivadoWorkspace/pwm_led/pwm_led.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
